...
5. Users can install: `TEAM_CONTEXT_VERSION=v1.0.1 bash <(curl -fsSL https://raw.githubusercontent.com/usewayfind/wayfind/main/install.sh)`

## Version Stability

- `main` branch always has the latest code (use for development)
- Tags are immutable pinned releases (use for production installs)
- The one-line installer defaults to `main` — use `TEAM_CONTEXT_VERSION=` to pin
